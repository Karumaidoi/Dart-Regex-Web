...
function RegexCard({ regex }) {
  return (
    <Link to={regex?.to} state={regex}>
      <div className="flex cursor-pointer flex-col items-center rounded-md border-[2px] border-solid border-stone-100  px-10 py-8 hover:shadow-md hover:shadow-stone-100/100 dark:shadow-stone-800/10 sm:flex-row lg:h-[15rem]">
